...
export const lang = {
  ...
  meetingTab: 'Meeting',
  voiceLiveRoom: 'Voice Live Rooms',
  noLiveRoom: 'No live rooms',
  retryLiveRoomTip: 'Please try again later or use other filters',
  meetingFeatureDisabled: 'Meeting feature is disabled in the current environment',
  meetingRoomPassword: 'Enter room password',
  meetingRoomPasswordHint: 'Please enter password',
  ...
  globalSearchChatHistory: 'Messages',
  globalSearchChatFile: 'Files',
  searchHint: 'Search contacts, groups, chat history, and files by keyword',
  searchNoResult: 'No results found',
  searchChatHistoryHint: 'Enter a keyword to search chat history',
  searchChatHistoryNoResult: 'No related records found',
  searchChatHistoryPlaceholder: 'Search chat history',
  searchGroupID: 'Search Group ID',
  emptyGroupAnnouncement: 'No notice yet',
  source: 'Source',
  selectAtMember: 'Select At Member',
  find: 'Find',
  lineSwitchTitle: 'Switch Line',
  lineSwitchDesc: 'Tap to switch. Latency test results are shown on the right.',
  lineSwitchReloginTip: 'Switching lines will log you out. Please sign in again.',
  lineCurrent: 'Current',
  ...
  confirmDeleteConversation:
    'Are you sure you want to delete this conversation? All chat history will be removed.',
  pinConversationSuccess: 'Conversation pinned',
  unpinConversationSuccess: 'Conversation unpinned',
  pinConversationFailed: 'Failed to update pinned conversation status',
  setDoNotDisturbSuccess: 'Do not disturb enabled',
  ...
  profileMenu: {
    ...
    uploadFrontHint: 'Please upload the front of your ID card',
    uploadBackHint: 'Please upload the back of your ID card',
    searchFavorites: 'Search Favorites',
    emptyFavorites: 'No favorites yet',
    emptySearchFavorites: 'No matching favorites found',
  ...
  messageTip: {
    ...
    broadcastTargetEmpty: 'Please select contacts or groups to send to',
    broadcastContentEmpty: 'Please enter the broadcast content',
    broadcastAllSuccess: 'Sent successfully to {count} conversations',
    broadcastPartialSuccess: 'Sent to {success} successfully, failed for {failed}',
    lineSwitched: 'Switched to {line}.',
    lineSwitchedRelogin: 'Switched to {line}. Please sign in again.',
    unsupportedFavoriteMessage: 'This message type is not supported for favorites',
    canNotRevokeMessage: 'This message cannot be revoked',
    canNotDeleteMessage: 'This message cannot be deleted',
    revokeLimit: 'Messages sent more than 2 minutes ago cannot be revoked',
    revokeSelfTitle: 'Revoke Message',
    revokeOtherTitle: 'Revoke Group Member Message',
    revokeSelfConfirm: 'Are you sure you want to revoke this message?',
    revokeOtherConfirm:
      'Are you sure you want to revoke this group member message?',
    revokeSuccess: 'Message revoked',
    revokeFailed: 'Failed to revoke message!',
    deleteMessageTitle: 'Delete Message',
    deleteMessageConfirm:
      'Are you sure you want to delete this message? This action cannot be undone.',
    deleteMultiMessageConfirm:
      'Are you sure you want to delete the selected {count} messages? This action cannot be undone.',
    deleteFailed: 'Delete failed!',
    selectMessage: 'Please select messages',
    forwardSuccess: 'Forwarded successfully!',
    forwardFailed: 'Forward failed!',
    inputWithdrawAccount: 'Please enter the receiving account',
    correctRealName: 'Name must be 2-20 Chinese characters',
    inputRealName: 'Please enter your real name',
    inputIDCard: 'Please enter your ID card number',
    correctIDCard: 'Invalid ID card number format',
    uploadIDCardFront: 'Please upload the front of your ID card',
    uploadIDCardBack: 'Please upload the back of your ID card',
    ...
    meetingRoomNoGroup: 'This meeting is not bound to a group, so the live room cannot be opened',
    meetingPasswordEmpty: 'Please enter the room password',
    meetingPasswordError: 'Incorrect password',
  },
  date: {
    seconds: 'seconds',
    minute: 'minute',
  ...
  rtc: {
    ...
    video: 'Video Call',
    canceled: 'Canceled',
    canceledByCaller: 'Canceled by Caller',
    refused: 'Refused',
